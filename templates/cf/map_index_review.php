...
<html lang="en">
<head>
    <title>WCFCourier.com | Map: Crimes reported in Cedar Falls, Iowa in 2013</title>
    
    <link rel="shortcut icon" type="image/x-icon" href="http://wcfcourier.com/icon.ico" />
    <meta name="description" content="This map displays crimes reported in Cedar Falls, Iowa." />
    <meta name="keywords" content="Cedar Falls,Iowa,crime,Courier" />
    ...
    <meta property="twitter:title" content="Crimes reported in the Cedar Falls">
    ...
    <!-- <link rel="stylesheet" href="http://wcfcourier.com/app/crime_map2013/css/lib/leaflet.awesome-markers.css" /> -->
...
<div class="description_box box-shadow">
    ...
    - <a href="http://wcfcourier.com/app/crime_map2013/index_mobile_cf.php">View reports for December and other months in Cedar Falls</a>
    <br />
    - <a href="http://wcfcourier.com/app/crime_map2013/templates/wloo/map_index_review.php">View crime map for Waterloo</a>
    <br />
    <br />
    <div id="credits">
...
<script src="http://wcfcourier.com/app/crime_map2013/JSON_cf/crime_data_review_violent.json"></script>
<script src="http://wcfcourier.com/app/crime_map2013/JSON_cf/crime_data_review_property.json"></script>
...
<!--[if !IE]><!-->
<script src="http://wcfcourier.com/app/crime_map2013/JSON_cf/crime_data.json"></script>
<script type="text/javascript">
if ($(window).width() > 626) {
  tableCreate();
}   
