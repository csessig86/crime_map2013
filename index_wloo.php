...
if ((screen.width < 640) && (screen.height < 960)) {
	document.location='index_mobile_wloo.php';
}
//-->
<!--
if ((navigator.userAgent.match(/iPhone/i)) || 
	...
	(navigator.userAgent.match(/BlackBerry/))) {
		location.replace("index_mobile_wloo.php");
}
-->
</script>
...
<h2 id='city_name'>Crimes reported in Waterloo, Iowa</h2>
...
/* You may give each page an identifying name, server, and channel on the next lines. */
    s.pageName="Crimes reported in Waterloo"
    s.server="Waterloo"
